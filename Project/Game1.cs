...
namespace Project
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //Test: link = LinkSpriteFactory.Instance.CreateLinkWalkingSprite(Entities.Facing.Left);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //Test: link.Draw(_spriteBatch, new Vector2(200, 200));
