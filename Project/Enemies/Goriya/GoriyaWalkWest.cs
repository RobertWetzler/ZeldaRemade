...
namespace Project
{
    class GoriyaWalkWest : IEnemyState
    {
        ...
        {
            this.goriya = goriya;
            this.goriya.EnemySprite = NPCEnemySpriteFactory.Instance.CreateGoriyaWalkWestSprite();
        ...
        {
            goriya.XPos += (float)(-1 * gameTime.ElapsedGameTime.TotalSeconds * goriya.Velocity);
        }
