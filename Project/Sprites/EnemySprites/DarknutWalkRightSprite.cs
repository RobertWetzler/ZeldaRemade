...
namespace Project
{
    class DarknutWalkRightSprite : ISprite
    {
        ...
        public DarknutWalkRightSprite(Texture2D darknutSpriteSheet, List<Rectangle> sourceFrames)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 position, Color color)
        {
            ...
            spriteBatch.Draw(darknutSpriteSheet, destRectangle, source, Color.White);
        }
