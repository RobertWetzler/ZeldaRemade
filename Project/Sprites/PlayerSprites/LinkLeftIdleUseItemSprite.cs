...
{
    public class LinkLeftIdleUseItemSprite : IPlayerSprite
    {   /*
         * TODO: need to mirror the sprite
        ...
        public LinkLeftIdleUseItemSprite(Texture2D playerSpriteSheet, int sheetRows, int sheetColumns)
        {
