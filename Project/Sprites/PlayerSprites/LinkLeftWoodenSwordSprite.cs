...
{
    public class LinkLeftWoodenSwordSprite : IPlayerSprite
    {
        // TODO: need to mirror the sprites
        ...
        public LinkLeftWoodenSwordSprite(Texture2D playerSpriteSheet, int sheetRows, int sheetColumns)
        {
