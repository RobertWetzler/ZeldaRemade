...
{
    class HealthSprite : IItemSprite
    {
        ...
        public HealthSprite(Texture2D spriteSheet, int sheetRows, int sheetColumns)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 position)
        {
            ...
            int height = spriteSheet.Height / sheetRows + 3;
            int scale = 2;
        ...
        {
            frame = (int)(gameTime.TotalGameTime.TotalSeconds * 3) % 3;
        }
    }
}
